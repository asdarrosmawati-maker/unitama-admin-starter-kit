<x-app>
    ...
    <div class="card shadow p-3">
        ...
        <div>
            <a class="btn btn-primary mb-3" href="{{ route('users.create') }}" role="button">CREATE</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                ...
                                <button type="button" class="btn btn-info btn-sm btn-detail" data-bs-toggle="modal"
                                    data-bs-target="#detailModal" data-route="{{ route('users.show', $user) }}">
                                    <i class='bx bx-show'></i>
                                </button>


                                <a class="btn btn-warning btn-sm " href="{{ route('users.edit', $user) }}"
                                    role="button"><i class='bx bx-edit-alt'></i></a>

                                <button type="button" class="btn btn-danger btn-sm btn-delete" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" data-route="{{ route('users.destroy', $user) }}">
